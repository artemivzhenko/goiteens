...
with open("labirints/l2.json", 'r') as file:
    maze_json = json.load(file)
player_x, player_y = maze_json["player"]
door_x, door_y = maze_json["door"]
...
door_image = pygame.image.load("Door_#1.png")
gameover = pygame.image.load("End_#1.jpg")
MMM_1 = pygame.image.load("Wall.png")
...
start_background = pygame.image.load("Wall.png")
